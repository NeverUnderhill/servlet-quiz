	...
	<body>  
		...
		<div class="container">
			...
			<div class="row" style="text-align:center">
 				<table class="table col-6" id="editorQuizzesTable">  
					<thead>
						<tr>
							<th scope="col">#</th>
						...
						<tr>
							...
							<td>
								<button type="button" class="btn btn-success"
													  onclick="editEditorsQuiz(this.parentNode.parentNode.rowIndex - 1)"><i class="fa fa-pencil"></i></button>
								<button type="button" class="btn btn-danger"
													  onclick="deleteEditorsQuiz(this.parentNode.parentNode.rowIndex - 1);location.reload();"><i class="fa fa-trash"></i></button>
							</td>
						</tr>  
					</tbody>
				</table>  
